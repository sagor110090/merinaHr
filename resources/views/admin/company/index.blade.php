        ...
        <div class="card-body">
            <div class="d-md-flex align-items-center">
                <div>
                    ...
                    <h5 class="card-subtitle">Create New Company</h5>
                </div>
            </div>
                ...
                <table class="table" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->address }}</td>
                            <td>
                                <a href="{{ url('/admin/company/' . $item->id) }}" title="View Company"><button
                                        class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i>
                                        View</button></a>
                                <a href="{{ url('/admin/company/' . $item->id . '/edit') }}"
                                    title="Edit Company"><button class="btn btn-primary btn-sm"><i class="fa fa-edit"
                                            aria-hidden="true"></i>
                                        Edit</button></a>
