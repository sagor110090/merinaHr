                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="dataTable">
                            <thead>
                                <tr>
                                    <th>#</th><th>Employee Name</th><th>Picture</th><th>Age</th><th>Address</th><th>Mobile</th><th>Email</th><th>File</th><th>Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->employee->fname }} {{ $item->employee->lname }}</td><td>{{ $item->picture }}</td><td>{{ $item->age }}</td><td>{{ $item->address }}</td><td>{{ $item->mobile }}</td><td>{{ $item->email }}</td><td>{{ $item->file }}</td>
                                    <td>
